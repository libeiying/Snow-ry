...
--
-- Host: rm-bp1ssd9u6zogr9477fo.rwlb.rds.aliyuncs.com    Database: snow
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'c0aad4b1-414f-11f1-b66d-00163e1973d0:1-13357';
...
--
-- Table structure for table `nh_heritage`
--

DROP TABLE IF EXISTS `nh_heritage`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `nh_heritage` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `heritage_code` varchar(64) NOT NULL COMMENT '非遗编号',
  `name` varchar(200) NOT NULL COMMENT '非遗名称',
  `category` varchar(100) DEFAULT NULL COMMENT '非遗类别',
  `region` varchar(100) NOT NULL DEFAULT '东北' COMMENT '所属地区',
  `level` varchar(50) DEFAULT NULL COMMENT '非遗级别(国家级/省级/市级等)',
  `inheritor` varchar(100) DEFAULT NULL COMMENT '代表性传承人',
  `description` text COMMENT '非遗简介',
  `images_json` json DEFAULT NULL COMMENT '图片JSON数组，存多个本地图片路径',
  ...
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_heritage_code` (`heritage_code`),
  KEY `idx_name` (`name`),
  KEY `idx_region` (`region`),
  KEY `idx_category` (`category`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='东北非遗表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `nh_heritage`
--

LOCK TABLES `nh_heritage` WRITE;
/*!40000 ALTER TABLE `nh_heritage` DISABLE KEYS */;
INSERT INTO `nh_heritage` VALUES (1,'DB-FY-0001','东北大秧歌','传统舞蹈','东北','省级','李春生','东北大秧歌是东北地区代表性民间舞蹈，节奏热烈、动作夸张，常见于节庆活动。','[\"D:/nh-images/dongbei/yangge/1.jpg\", \"D:/nh-images/dongbei/yangge/2.jpg\", \"D:/nh-images/dongbei/yangge/3.jpg\"]','0','0','admin','2026-04-25 21:48:38','admin','2026-04-25 21:48:38','示例数据'),(2,'DB-FY-0002','长白山满族剪纸','传统美术','东北','市级','王秀兰','满族剪纸以民俗题材为主，纹样细腻，具有浓厚地域文化特色。','[\"D:/nh-images/dongbei/jianzhi/1.jpg\", \"D:/nh-images/dongbei/jianzhi/2.jpg\"]','0','0','admin','2026-04-25 21:48:38','admin','2026-04-25 21:48:38','示例数据');
/*!40000 ALTER TABLE `nh_heritage` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `nh_recommend_route`
--

DROP TABLE IF EXISTS `nh_recommend_route`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `nh_recommend_route` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
  `route_date` date NOT NULL COMMENT 'Route date',
  `spot_name` varchar(200) NOT NULL COMMENT 'Spot name',
  `sub_title` varchar(255) DEFAULT NULL COMMENT 'Sub title',
  `spot_content` text COMMENT 'Spot content',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Recommend route table';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `nh_recommend_route`
--

LOCK TABLES `nh_recommend_route` WRITE;
/*!40000 ALTER TABLE `nh_recommend_route` DISABLE KEYS */;
INSERT INTO `nh_recommend_route` VALUES (1,'2026-12-26','长白山天池·冰雪奇观','天池雪景&温泉体验&滑雪运动','天池雪景、温泉体验、滑雪运动等冬季特色路线。'),(2,'2026-12-27','漠河极光·神州北极之旅','极光观赏&北极村体验&冰雪探险','以极光观赏为核心，串联北极村和冰雪体验行程。'),(3,'2026-04-26','经典滑雪路线','适合初学者到中级滑雪爱好者的经典路线','经典滑雪线路，覆盖初中级雪道与常见配套服务。');
/*!40000 ALTER TABLE `nh_recommend_route` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `nh_scenic_spot`
--

DROP TABLE IF EXISTS `nh_scenic_spot`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `nh_scenic_spot` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
  `spot_name` varchar(200) NOT NULL COMMENT 'Spot name',
  `city` varchar(100) DEFAULT NULL COMMENT 'City',
  `spot_content` text COMMENT 'Spot content',
  `images_json` json DEFAULT NULL COMMENT 'Image JSON array',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Northeast scenic spot table';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `nh_scenic_spot`
--

LOCK TABLES `nh_scenic_spot` WRITE;
/*!40000 ALTER TABLE `nh_scenic_spot` DISABLE KEYS */;
INSERT INTO `nh_scenic_spot` VALUES (1,'Harbin Ice and Snow World','Harbin','Large winter ice and snow theme park with night light shows and ice sculptures.','[\"D:/nh-images/scenic/harbin-ice-world/1.jpg\", \"D:/nh-images/scenic/harbin-ice-world/2.jpg\"]'),(2,'Yabuli Ski Resort','Harbin','Major ski destination in Northeast China with beginner to advanced slopes.','[\"D:/nh-images/scenic/yabuli/1.jpg\", \"D:/nh-images/scenic/yabuli/2.jpg\"]'),(3,'Changbai Mountain Tianchi','Baishan','Winter route featuring snow scenery, hot springs and panoramic mountain views.','[\"D:/nh-images/scenic/changbai-tianchi/1.jpg\", \"D:/nh-images/scenic/changbai-tianchi/2.jpg\"]');
/*!40000 ALTER TABLE `nh_scenic_spot` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `order_item` (`id`, `order_id`, `order_no`, `user_id`, `product_id`, `product_code`, `product_title`, `product_image`, `sku_text`, `unit_price`, `quantity`, `create_time`, `update_time`) VALUES (1,1,'2026042616184035200100',100,2,'CC-TEST-002','中央大街雪花珐琅胸针','https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=1200&q=80',NULL,45.00,1,'2026-04-26 16:18:40','2026-04-26 16:18:40'),(2,2,'2026042616224233400100',100,2,'CC-TEST-002','中央大街雪花珐琅胸针','https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=1200&q=80',NULL,45.00,2,'2026-04-26 16:22:42','2026-04-26 16:22:42'),(3,3,'2026042616383072900100',100,2,'CC-TEST-002','中央大街雪花珐琅胸针','https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=1200&q=80',NULL,45.00,3,'2026-04-26 16:38:30','2026-04-26 16:38:30'),(4,4,'2026042619252635400000',0,2,'CC-TEST-002','中央大街雪花珐琅胸针','https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=1200&q=80',NULL,45.00,1,'2026-04-26 19:25:26','2026-04-26 19:25:26'),(5,5,'2026042619323056500000',0,2,'CC-TEST-002','中央大街雪花珐琅胸针','https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=1200&q=80',NULL,45.00,2,'2026-04-26 19:32:30','2026-04-26 19:32:30'),(6,5,'2026042619323056500000',0,1,'CC-TEST-001','哈尔滨浮雕金属创意冰箱贴·城市记忆款','https://images.unsplash.com/photo-1511919884226-fd3cad34687c?auto=format&fit=crop&w=1200&q=80',NULL,32.90,2,'2026-04-26 19:32:30','2026-04-26 19:32:30'),(7,6,'2026042620513497800100',100,2,'CC-TEST-002','中央大街雪花珐琅胸针','https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=1200&q=80',NULL,45.00,4,'2026-04-26 20:51:35','2026-04-26 20:51:35');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='订单支付流水表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order_payment` VALUES (1,'PAY20260426163835003900100','2026042616383072900100',100,135.00,'WECHAT','1','MOCK-1777192714986-a69a95','{\"source\":\"snowTravel-payment-page\",\"payMethod\":\"WECHAT\",\"orderNo\":\"2026042616383072900100\",\"amount\":135}',NULL,'2026-04-26 16:38:35','2026-04-26 16:38:35','2026-04-26 16:38:35'),(2,'PAY20260426192615288400000','2026042619252635400000',0,45.00,'WECHAT','1','MOCK-1777202775088-5a5c23','{\"source\":\"snowTravel-payment-page\",\"payMethod\":\"WECHAT\",\"orderNo\":\"2026042619252635400000\",\"amount\":45}',NULL,'2026-04-26 19:26:15','2026-04-26 19:26:15','2026-04-26 19:26:15'),(3,'PAY20260426205141097800100','2026042620513497800100',100,180.00,'WECHAT','1','MOCK-1777207900851-79f414','{\"source\":\"snowTravel-payment-page\",\"payMethod\":\"WECHAT\",\"orderNo\":\"2026042620513497800100\",\"amount\":180}',NULL,'2026-04-26 20:51:40','2026-04-26 20:51:40','2026-04-26 20:51:40');
...
INSERT INTO `orders` VALUES (1,'2026042616184035200100',100,'2','0',45.00,45.00,'张三','13800138000','黑龙江省哈尔滨市道里区中央大街','',NULL,NULL,NULL,NULL,'2026-04-26 16:18:40','2026-04-26 16:18:50'),(2,'2026042616224233400100',100,'2','0',90.00,90.00,'默认收货人','13800138000','黑龙江省哈尔滨市道里区中央大街','',NULL,NULL,NULL,NULL,'2026-04-26 16:22:42','2026-04-26 16:37:15'),(3,'2026042616383072900100',100,'1','1',135.00,135.00,'默认收货人','13800138000','黑龙江省哈尔滨市道里区中央大街','',NULL,NULL,NULL,NULL,'2026-04-26 16:38:30','2026-04-26 16:38:35'),(4,'2026042619252635400000',0,'1','1',45.00,45.00,'默认收货人','13800138000','黑龙江省哈尔滨市道里区中央大街','',NULL,NULL,NULL,NULL,'2026-04-26 19:25:26','2026-04-26 19:26:15'),(5,'2026042619323056500000',0,'2','0',155.80,155.80,'默认收货人','13800138000','黑龙江省哈尔滨市道里区中央大街','',NULL,'2026-04-26 19:47:59',NULL,NULL,'2026-04-26 19:32:30','2026-04-26 19:47:59'),(6,'2026042620513497800100',100,'1','1',180.00,180.00,'23033112','13800138000','黑龙江省哈尔滨市道里区中央大街','',NULL,NULL,NULL,NULL,'2026-04-26 20:51:34','2026-04-26 20:51:41');
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='购物车单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `shopping_cart` (`id`, `user_id`, `product_id`, `product_code`, `product_title`, `product_sub_title`, `product_image`, `sku_text`, `unit_price`, `quantity`, `is_checked`, `status`, `invalid_reason`, `create_time`, `update_time`) VALUES (5,100,2,'CC-TEST-002','中央大街雪花珐琅胸针','法式珐琅工艺，冬季穿搭点睛','https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=1200&q=80',NULL,45.00,4,'1','2',NULL,'2026-04-26 16:18:27','2026-04-26 20:51:35'),(6,0,2,'CC-TEST-002','中央大街雪花珐琅胸针','法式珐琅工艺，冬季穿搭点睛','https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=1200&q=80',NULL,45.00,2,'1','2',NULL,'2026-04-26 19:23:45','2026-04-26 19:32:30'),(7,0,1,'CC-TEST-001','哈尔滨浮雕金属创意冰箱贴·城市记忆款','冰城地标浮雕，磁力稳固，旅行纪念','https://images.unsplash.com/photo-1511919884226-fd3cad34687c?auto=format&fit=crop&w=1200&q=80',NULL,32.90,2,'1','2',NULL,'2026-04-26 19:32:15','2026-04-26 19:32:30');
/*!40000 ALTER TABLE `shopping_cart` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `snow_address`
--

DROP TABLE IF EXISTS `snow_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `snow_address` (
  ...
  `is_default` char(1) NOT NULL DEFAULT 'N' COMMENT '是否默认地址(Y是 N否)',
  `address_status` char(1) NOT NULL DEFAULT '0' COMMENT '地址状态(0正常 1停用)',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`address_id`),
  KEY `idx_hld_user_address_default` (`user_id`,`is_default`),
  KEY `idx_hld_user_address_user_id` (`user_id`),
  CONSTRAINT `fk_hld_user_address_user_id` FOREIGN KEY (`user_id`) REFERENCES `sys_user` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3 COMMENT='用户收货地址表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `snow_address`
--

LOCK TABLES `snow_address` WRITE;
/*!40000 ALTER TABLE `snow_address` DISABLE KEYS */;
INSERT INTO `snow_address` VALUES (1,100,'张新','19089098989','220000','吉林省','220100','长春市','220103','宽城区','朱邦城市广场','2212134344','Y','0','2026-04-26 20:13:11','2026-04-26 20:13:11','');
/*!40000 ALTER TABLE `snow_address` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=178 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='定时任务调度日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_job_log` VALUES (1,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：65毫秒','0','','2026-04-26 16:14:00'),(2,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：17毫秒','0','','2026-04-26 16:15:00'),(3,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：10毫秒','0','','2026-04-26 16:16:00'),(4,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：16毫秒','0','','2026-04-26 16:17:00'),(5,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：7毫秒','0','','2026-04-26 16:18:00'),(6,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：9毫秒','0','','2026-04-26 16:19:00'),(7,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：6毫秒','0','','2026-04-26 16:20:00'),(8,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：10毫秒','0','','2026-04-26 16:21:00'),(9,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：14毫秒','0','','2026-04-26 16:22:00'),(10,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：8毫秒','0','','2026-04-26 16:23:00'),(11,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：6毫秒','0','','2026-04-26 16:24:00'),(12,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：6毫秒','0','','2026-04-26 16:25:00'),(13,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：19毫秒','0','','2026-04-26 16:27:00'),(14,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：9毫秒','0','','2026-04-26 16:28:00'),(15,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：34毫秒','0','','2026-04-26 16:29:00'),(16,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：8毫秒','0','','2026-04-26 16:30:00'),(17,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：10毫秒','0','','2026-04-26 16:31:00'),(18,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：8毫秒','0','','2026-04-26 16:32:00'),(19,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：11毫秒','0','','2026-04-26 16:33:00'),(20,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：10毫秒','0','','2026-04-26 16:34:00'),(21,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：9毫秒','0','','2026-04-26 16:35:00'),(22,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：8毫秒','0','','2026-04-26 16:36:00'),(23,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：10毫秒','0','','2026-04-26 16:37:00'),(24,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：9毫秒','0','','2026-04-26 16:39:00'),(25,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：8毫秒','0','','2026-04-26 16:40:00'),(26,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：7毫秒','0','','2026-04-26 16:41:00'),(27,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：11毫秒','0','','2026-04-26 16:42:00'),(28,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：12毫秒','0','','2026-04-26 16:43:00'),(29,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：0毫秒','0','','2026-04-26 16:44:00'),(30,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：7毫秒','0','','2026-04-26 16:45:00'),(31,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：11毫秒','0','','2026-04-26 16:46:00'),(32,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：6毫秒','0','','2026-04-26 16:47:00'),(33,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：12毫秒','0','','2026-04-26 16:48:00'),(34,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：7毫秒','0','','2026-04-26 16:49:00'),(35,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：7毫秒','0','','2026-04-26 16:50:00'),(36,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：15毫秒','0','','2026-04-26 16:51:00'),(37,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：11毫秒','0','','2026-04-26 16:52:00'),(38,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：10毫秒','0','','2026-04-26 16:53:00'),(39,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：9毫秒','0','','2026-04-26 16:54:00'),(40,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：6毫秒','0','','2026-04-26 16:55:00'),(41,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：8毫秒','0','','2026-04-26 16:56:00'),(42,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：6毫秒','0','','2026-04-26 16:57:00'),(43,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：10毫秒','0','','2026-04-26 16:58:00'),(44,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：0毫秒','0','','2026-04-26 16:59:00'),(45,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：0毫秒','0','','2026-04-26 17:00:00'),(46,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：3毫秒','0','','2026-04-26 17:01:00'),(47,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：4毫秒','0','','2026-04-26 17:02:00'),(48,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：4毫秒','0','','2026-04-26 17:03:00'),(49,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：9毫秒','0','','2026-04-26 17:04:00'),(50,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：8毫秒','0','','2026-04-26 17:05:00'),(51,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：5毫秒','0','','2026-04-26 17
'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：334毫秒','0','','2026-04-26 20:43:00'),(165,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：327毫秒','0','','2026-04-26 20:44:00'),(166,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：355毫秒','0','','2026-04-26 20:45:00'),(167,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：347毫秒','0','','2026-04-26 20:46:00'),(168,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：341毫秒','0','','2026-04-26 20:47:00'),(169,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：332毫秒','0','','2026-04-26 20:48:00'),(170,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：332毫秒','0','','2026-04-26 20:49:00'),(171,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：336毫秒','0','','2026-04-26 20:50:00'),(172,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：298毫秒','0','','2026-04-26 20:51:00'),(173,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：321毫秒','0','','2026-04-26 20:52:00'),(174,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：340毫秒','0','','2026-04-26 20:53:00'),(175,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：316毫秒','0','','2026-04-26 20:54:00'),(176,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：361毫秒','0','','2026-04-26 20:55:00'),(177,'订单超时自动取消','DEFAULT','orderTask.cancelTimeoutOrders()','订单超时自动取消 总共耗时：330毫秒','0','','2026-04-26 20:56:00');
...
INSERT INTO `sys_logininfor` VALUES (100,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-25 10:56:17'),(101,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-25 11:27:57'),(102,'23033112','127.0.0.1','内网IP','Chrome 14','Windows 10','0','注册成功','2026-04-25 11:36:07'),(103,'23033112','127.0.0.1','内网IP','Chrome 14','Windows 10','1','验证码已失效','2026-04-25 11:36:14'),(104,'23033112','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-25 11:36:19'),(105,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','退出成功','2026-04-25 11:44:13'),(106,'23033112','127.0.0.1','内网IP','Chrome 14','Windows 10','1','验证码已失效','2026-04-25 12:09:56'),(107,'23033112','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-25 12:10:01'),(108,'23033112','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-25 13:41:44'),(109,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-25 14:45:36'),(110,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','退出成功','2026-04-25 15:02:16'),(111,'23033112','127.0.0.1','内网IP','Chrome 14','Windows 10','1','验证码已失效','2026-04-25 15:16:50'),(112,'23033112','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-25 15:16:53'),(113,'23033112','127.0.0.1','内网IP','Chrome 14','Windows 10','1','验证码已失效','2026-04-25 15:17:12'),(114,'23033112','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-25 15:17:15'),(115,'23033101','127.0.0.1','内网IP','Chrome 14','Windows 10','0','注册成功','2026-04-25 20:13:12'),(116,'23033112','127.0.0.1','内网IP','Chrome 14','Windows 10','1','验证码已失效','2026-04-25 20:40:03'),(117,'23033112','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-25 20:40:08'),(118,'23033112','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-25 21:21:14'),(119,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-25 22:18:02'),(120,'23033112','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-26 14:32:54'),(121,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','1','验证码已失效','2026-04-26 14:34:01'),(122,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-26 14:34:05'),(123,'23033112','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-26 15:32:40'),(124,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','1','验证码已失效','2026-04-26 16:17:27'),(125,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-26 16:17:31'),(126,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-26 19:16:29'),(127,'admin','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-26 19:59:50'),(128,'23033112','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-26 20:11:41'),(129,'23033112','127.0.0.1','内网IP','Chrome 14','Windows 10','0','登录成功','2026-04-26 20:46:16');
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2026-04-25 10:31:31','',NULL,'超级管理员'),(2,'普通角色','common',2,'2',0,1,'0','0','admin','2026-04-25 10:31:31','admin','2026-04-26 20:00:10','普通角色');
...
INSERT INTO `sys_user` VALUES (1,103,'admin','若依','00','ry@163.com','15888888888','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2026-04-26 19:59:51','admin','2026-04-25 10:31:31','','2026-04-26 19:59:50','管理员'),(2,105,'ry','若依','00','ry@qq.com','15666666666','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2026-04-25 10:31:31','admin','2026-04-25 10:31:31','',NULL,'测试员'),(100,NULL,'23033112','23033112','00','s11212li@2925.com','19022112121','0','/profile/avatar/2026/04/26/pexels-souvenirpixels-417074_20260426201159A001.jpg','$2a$10$d9zlSVUYOBfBRvj30uob/.mVoYx4ggJhQ/bLH/JqPMcuiS4py0Ynu','0','0','127.0.0.1','2026-04-26 20:46:16','','2026-04-25 11:36:07','admin','2026-04-26 20:46:36',NULL),(101,NULL,'23033101','23033101','00','','','0','','$2a$10$ARN.V0tCcxJfZAyGZaiCsOk0U3qOKodsSxvOLQfHMBV/5.Eg12VgC','0','0','',NULL,'','2026-04-25 20:13:12','admin','2026-04-26 20:00:34',NULL);
...
-- Dump completed on 2026-04-27 10:17:28
